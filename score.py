...
class Score:
    def __init__(self, songid, songname, difficulty, chart, rivalcode, score, combotype):
        self.songid = songid
...
def query_scorepage(rivalcode, difficulty):
    ...
    return list(map(lambda x: Score(x[0], x[1], difficulty, x[2], rivalcode, x[3], x[4]), full_data))
